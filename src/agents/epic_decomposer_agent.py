"""Epic Decomposer Agent — groups stories into epics and breaks them into tasks.
...
class EpicDecomposerAgent(Agent):
    ...
    def __init__(
        ...
        *,
        ...
        if self.claude is None:
            raise AgentError("EpicDecomposerAgent requires an LLM tool (claude= or tool=).")
