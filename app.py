...
if not _auth_disabled:
    ...
    if _entra_enabled():
        ...
        if "entra_user" not in st.session_state:
            ...
            # ── retail icon constellation (4 icons, 3 rings, center 170,170, viewBox 340x340) ─
            # Store (top) · Cart (right) · Box (bottom) · Tag (left) — gold connections
            _brain = (
                '<svg viewBox="0 0 340 340" fill="none" xmlns="http://www.w3.org/2000/svg" '
                'style="width:min(75%,440px);height:auto;display:block;">'
                '<defs>'
                '<filter id="rf-g" x="-60%" y="-60%" width="220%" height="220%">'
                '<feGaussianBlur stdDeviation="5" result="b"/>'
                '<feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge>'
                '</filter>'
                '<filter id="rf-gs" x="-80%" y="-80%" width="260%" height="260%">'
                '<feGaussianBlur stdDeviation="2.5" result="b"/>'
                '<feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge>'
                '</filter>'
                '<radialGradient id="rf-hub" cx="50%" cy="50%" r="50%">'
                '<stop offset="0%" stop-color="#fff9e6"/>'
                '<stop offset="100%" stop-color="#c084fc"/>'
                '</radialGradient>'
                '<radialGradient id="rf-icon" cx="35%" cy="35%" r="65%">'
                '<stop offset="0%" stop-color="#f0f4ff"/>'
                '<stop offset="100%" stop-color="#a78bfa"/>'
                '</radialGradient>'
                '</defs>'
                # outer ring adjacents (faint gold)
                '<line x1="325" y1="170" x2="304" y2="248" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="248" y1="304" x2="170" y2="325" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="93" y1="304" x2="36" y2="248" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="15" y1="170" x2="36" y2="92" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="93" y1="36" x2="170" y2="15" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="248" y1="36" x2="304" y2="92" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                # mid→outer
                '<line x1="267" y1="130" x2="304" y2="92" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="267" y1="130" x2="325" y2="170" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="267" y1="210" x2="325" y2="170" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="267" y1="210" x2="304" y2="248" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="210" y1="267" x2="248" y2="304" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="210" y1="267" x2="304" y2="248" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="130" y1="267" x2="93" y2="304" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="130" y1="267" x2="170" y2="325" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="73" y1="210" x2="36" y2="248" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="73" y1="210" x2="93" y2="304" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="73" y1="130" x2="36" y2="92" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="73" y1="130" x2="15" y2="170" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="130" y1="73" x2="93" y2="36" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="130" y1="73" x2="36" y2="92" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="210" y1="73" x2="170" y2="15" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="210" y1="73" x2="248" y2="36" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                # mid ring adjacents (octagon)
                '<line x1="267" y1="130" x2="267" y2="210" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="267" y1="210" x2="210" y2="267" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="210" y1="267" x2="130" y2="267" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="130" y1="267" x2="73" y2="210" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="73" y1="210" x2="73" y2="130" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="73" y1="130" x2="130" y2="73" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="130" y1="73" x2="210" y2="73" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                '<line x1="210" y1="73" x2="267" y2="130" stroke="rgba(167,139,250,0.25)" stroke-width="0.9"/>'
                # inner icons → mid ring
                '<line x1="170" y1="95" x2="130" y2="73" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="170" y1="95" x2="210" y2="73" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="245" y1="170" x2="267" y2="130" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="245" y1="170" x2="267" y2="210" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="170" y1="245" x2="210" y2="267" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="170" y1="245" x2="130" y2="267" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="95" y1="170" x2="73" y2="130" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                '<line x1="95" y1="170" x2="73" y2="210" stroke="rgba(167,139,250,0.32)" stroke-width="1.0"/>'
                # square cross-connections between icons (very faint)
                '<line x1="170" y1="95" x2="245" y2="170" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="245" y1="170" x2="170" y2="245" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="170" y1="245" x2="95" y2="170" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                '<line x1="95" y1="170" x2="170" y2="95" stroke="rgba(109,40,217,0.22)" stroke-width="0.7"/>'
                # hub spokes — animated dashes flow outward from hub to each icon
                '<line x1="170" y1="170" x2="170" y2="95" stroke="rgba(167,139,250,0.85)" stroke-width="1.5" '
                'stroke-dasharray="8 4" style="animation:flow 1.1s linear infinite;"/>'
                '<line x1="170" y1="170" x2="245" y2="170" stroke="rgba(167,139,250,0.85)" stroke-width="1.5" '
                'stroke-dasharray="8 4" style="animation:flow 1.1s linear 0.28s infinite;"/>'
                '<line x1="170" y1="170" x2="170" y2="245" stroke="rgba(167,139,250,0.85)" stroke-width="1.5" '
                'stroke-dasharray="8 4" style="animation:flow 1.1s linear 0.55s infinite;"/>'
                '<line x1="170" y1="170" x2="95" y2="170" stroke="rgba(167,139,250,0.85)" stroke-width="1.5" '
                'stroke-dasharray="8 4" style="animation:flow 1.1s linear 0.83s infinite;"/>'
                # outer ring nodes (12 tiny gold dots)
                '<circle cx="325" cy="170" r="2" fill="rgba(109,40,217,0.48)"/>'
                '<circle cx="304" cy="248" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="248" cy="304" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="170" cy="325" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="93" cy="304" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="36" cy="248" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="15" cy="170" r="2" fill="rgba(109,40,217,0.48)"/>'
                '<circle cx="36" cy="92" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="93" cy="36" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="170" cy="15" r="2" fill="rgba(109,40,217,0.48)"/>'
                '<circle cx="248" cy="36" r="2" fill="rgba(109,40,217,0.42)"/>'
                '<circle cx="304" cy="92" r="2" fill="rgba(109,40,217,0.48)"/>'
                # mid ring nodes (8 small gold dots)
                '<circle cx="267" cy="130" r="3" fill="rgba(167,139,250,0.82)" filter="url(#rf-gs)"/>'
                '<circle cx="267" cy="210" r="3" fill="rgba(167,139,250,0.82)" filter="url(#rf-gs)"/>'
                '<circle cx="210" cy="267" r="3" fill="rgba(109,40,217,0.78)" filter="url(#rf-gs)"/>'
                '<circle cx="130" cy="267" r="3" fill="rgba(109,40,217,0.78)" filter="url(#rf-gs)"/>'
                '<circle cx="73" cy="210" r="3" fill="rgba(109,40,217,0.78)" filter="url(#rf-gs)"/>'
                '<circle cx="73" cy="130" r="3" fill="rgba(109,40,217,0.78)" filter="url(#rf-gs)"/>'
                '<circle cx="130" cy="73" r="3" fill="rgba(167,139,250,0.82)" filter="url(#rf-gs)"/>'
                '<circle cx="210" cy="73" r="3" fill="rgba(167,139,250,0.82)" filter="url(#rf-gs)"/>'
                # ── STORE icon · Heroicons building-storefront (top · 170,95) ──────
                '<g transform="translate(170,95)">'
                '<circle r="14" fill="rgba(12,6,28,0.9)"/>'
                '<circle r="14" fill="none" stroke="rgba(167,139,250,0.45)" stroke-width="1.1"/>'
                '<g transform="translate(-9,-9) scale(0.75)">'
                '<path d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 '
                ...
                '3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 '
                '1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 '
                ...
                '</g>'
                '</g>'
                # ── SHOPPING CART icon · Heroicons shopping-cart (right · 245,170) ─
                '<g transform="translate(245,170)">'
                '<circle r="14" fill="rgba(12,6,28,0.9)"/>'
                '<circle r="14" fill="none" stroke="rgba(167,139,250,0.45)" stroke-width="1.1"/>'
                '<g transform="translate(-9,-9) scale(0.75)">'
                '<path d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 '
                '2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 '
                '0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" '
                'stroke="#a78bfa" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" '
                'vector-effect="non-scaling-stroke"/>'
                '</g>'
                '</g>'
                # ── AI AGENT icon · Heroicons sparkles (bottom · 170,245) ──────────
                '<g transform="translate(170,245)">'
                '<circle r="14" fill="rgba(12,6,28,0.9)"/>'
                '<circle r="14" fill="none" stroke="rgba(167,139,250,0.45)" stroke-width="1.1"/>'
                '<g transform="translate(-9,-9) scale(0.75)">'
                '<path d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 '
                '003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 '
                '3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 '
                '3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 '
                '3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 '
                '18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394'
                '-1.183.394a2.25 2.25 0 00-1.423 1.423z" '
                'stroke="#a78bfa" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" '
                'vector-effect="non-scaling-stroke"/>'
                '</g>'
                '</g>'
                # ── TAG icon · Heroicons tag (left · 95,170) ──────────────────────
                '<g transform="translate(95,170)">'
                '<circle r="14" fill="rgba(12,6,28,0.9)"/>'
                '<circle r="14" fill="none" stroke="rgba(167,139,250,0.45)" stroke-width="1.1"/>'
                '<g transform="translate(-9,-9) scale(0.75)">'
                '<path d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 '
                '1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 '
                '0 009.568 3zM6 6h.008v.008H6V6z" '
                'stroke="#a78bfa" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" '
                'vector-effect="non-scaling-stroke"/>'
                '</g>'
                '</g>'
                # animated pulse rings on retail icons
                '<circle cx="170" cy="95" r="14" fill="none" stroke="rgba(167,139,250,0.82)" stroke-width="1.2" '
                'style="animation:npulse 3.4s ease-in-out infinite;transform-origin:170px 95px;"/>'
                '<circle cx="245" cy="170" r="14" fill="none" stroke="rgba(109,40,217,0.78)" stroke-width="1.2" '
                'style="animation:npulse 3.4s ease-in-out 0.85s infinite;transform-origin:245px 170px;"/>'
                '<circle cx="170" cy="245" r="14" fill="none" stroke="rgba(109,40,217,0.78)" stroke-width="1.2" '
                'style="animation:npulse 3.4s ease-in-out 1.7s infinite;transform-origin:170px 245px;"/>'
                '<circle cx="95" cy="170" r="14" fill="none" stroke="rgba(109,40,217,0.78)" stroke-width="1.2" '
                'style="animation:npulse 3.4s ease-in-out 2.55s infinite;transform-origin:95px 170px;"/>'
                # hub glow rings
                ...
                '<circle cx="170" cy="170" r="22" fill="rgba(167,139,250,0.10)" '
                'style="animation:hring 3.6s ease-in-out 1.8s infinite;transform-origin:170px 170px;"/>'
                # ── HUB: Heroicons shopping-bag ───────────────────────────────────
                '<g transform="translate(170,170)" filter="url(#rf-g)">'
                '<circle r="16" fill="rgba(12,6,28,0.94)"/>'
                '<circle r="16" fill="none" stroke="rgba(167,139,250,0.82)" stroke-width="1.5"/>'
                '<g transform="translate(-9,-9) scale(0.75)">'
                '<path d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 '
                '1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 '
                '1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 '
                '0 11-.75 0 .375.375 0 01.75 0z" '
                'stroke="#c4b5fd" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" '
                'vector-effect="non-scaling-stroke"/>'
                '</g>'
                '</g>'
                '</svg>'
            ...
            st.markdown(
                ...
                f'<div style="font-size:12px;font-weight:600;color:rgba(255,255,255,0.38);'
                f'letter-spacing:0.13em;text-transform:uppercase;margin-bottom:6px;">'
                f'Welcome to NorthStar Retail'
                f'</div>'
                f'<div style="font-size:52px;font-weight:800;line-height:1.05;'
                f'letter-spacing:-0.05em;color:#f0f4ff;margin-bottom:14px;white-space:nowrap;">'
                f'Backlog&nbsp;'
                ...
                # retail icon constellation — fills remaining space, centred horizontally
                ...
                f'letter-spacing:-0.02em;margin-bottom:8px;">Secure Sign In</div>'
                f'<div style="text-align:center;font-size:13px;color:rgba(255,255,255,0.44);'
                f'line-height:1.6;margin-bottom:24px;">'
                f'Use your Microsoft work account to access<br>the NorthStar Retail Backlog Intelligence Hub.'
                f'</div>'
                ...
                f'Microsoft Entra ID<span style="{_DOT}"></span>Enterprise SSO<span style="{_DOT}"></span>End&#8209;to&#8209;end Encrypted'
                f'</div>'
